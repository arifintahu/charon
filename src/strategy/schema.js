export const STRATEGY_FIELDS = {
  ...
  max_dev_team_hold_rate:    { type: 'number',  required: true },
  max_sniper_hold_rate:      { type: 'number',  required: true },
  max_gmgn_bundler_rate:     { type: 'number',  required: true },
  max_bot_degen_rate:        { type: 'number',  required: true },
  ...
  trailing_arm_percent:      { type: 'number',  required: true },
